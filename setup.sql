...
-- #####################################################################
-- 34. INATIVOS (2024 / 2025) — reengajamento + aniversariantes
-- #####################################################################
-- Lista de ex-alunos pra campanha de recuperação. Fica numa tabela
-- separada de students (não são matrículas ativas, e boa parte não tem
-- dado completo — só o que sobrou do controle antigo). date_birth
-- começa vazio pra todo mundo: a base fornecida não tinha data de
-- nascimento, então o alerta de aniversariantes só passa a mostrar
-- alguém depois que a secretaria preencher essa data manualmente na tela.
...
CREATE INDEX IF NOT EXISTS idx_inactive_students_year ON inactive_students(cancel_year);

ALTER TABLE inactive_students ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "inactive_students_select" ON inactive_students;
DROP POLICY IF EXISTS "inactive_students_insert" ON inactive_students;
DROP POLICY IF EXISTS "inactive_students_update" ON inactive_students;
DROP POLICY IF EXISTS "inactive_students_delete" ON inactive_students;
CREATE POLICY "inactive_students_select" ON inactive_students FOR SELECT USING (has_role(ARRAY['super_admin','direcao','financeiro','secretaria']));
CREATE POLICY "inactive_students_insert" ON inactive_students FOR INSERT WITH CHECK (has_role(ARRAY['super_admin','direcao','financeiro','secretaria']));
CREATE POLICY "inactive_students_update" ON inactive_students FOR UPDATE USING (has_role(ARRAY['super_admin','direcao','financeiro','secretaria']));
CREATE POLICY "inactive_students_delete" ON inactive_students FOR DELETE USING (is_admin());

-- Aniversariantes de HOJE entre os inativos (só aparece quem tiver date_birth preenchido).
...
-- Backfill único da lista fornecida (2025.1 e 2024) — só insere se a tabela ainda estiver vazia.
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM inactive_students LIMIT 1) THEN
INSERT INTO inactive_students (name, course_level, class_day, cancel_month, cancel_year, phone) VALUES
('DAVI FERREIRA BENIS', 'KIDS 08 E 09', 'QUARTA-FEIRA', 'FEVEREIRO', 2025, '(99) 98218-1063'),
('JOAQUIM SOUSA', 'KIDS 04 E 05', 'SABADO', 'FEVEREIRO', 2025, '(99) 99189-7267'),
('MARIA CECILIA', 'KIDS 08 E 09', 'QUARTA-FEIRA', 'JANEIRO', 2025, NULL),
('ANNA LETICIA', 'LEVEL-1', 'QUINTA-FEIRA', 'FEVEREIRO', 2025, '(99) 98444-4477'),
('LARISSA RODRIGUES', 'STARTER', 'QUINTA-FEIRA', 'MARÇO', 2025, NULL),
('ANDRE ANDRADE', 'CONVERSAÇÃO', 'TERÇA-FEIRA', 'MARÇO', 2025, NULL),
('ANA LIZ', 'KIDS 04 E 05', 'SEGUNDA-FEIRA', 'JANEIRO', 2025, '(99) 99144-4173'),
('NOEMY', 'KIDS 04 E 05', 'SABADO', 'FEVEREIRO', 2025, '(99) 98153-9853'),
('PEDRO ARTHUR', 'KIDS 06 E 07', 'SABADO', 'FEVEREIRO', 2025, '(99) 98128-8517'),
('SAMUEL SALES', 'LEVEL 1', 'SABADO', 'ABRIL', 2025, NULL),
('MARIA ALICIA', 'KIDS 06 E 07', 'SABADO', 'ABRIL', 2025, '(99) 98278-3050'),
('THAMYS XAVIER', 'LEVEL 1', 'SABADO', 'ABRIL', 2025, '(99) 98493-2492'),
('SAULO PIETRO', 'KIDS 06 E 07', 'SABADO', 'MAIO', 2025, '(99) 98402-6953'),
('PERPETUO', 'TURMA ONLINE', 'SABADO', 'MAIO', 2025, '(99) 98126-9220'),
('ANA JULIA CRUZ', 'VIP', 'TERÇA-FEIRA', 'MAIO', 2025, NULL),
('HUGO LEONARDO', 'VIP', 'SEGUNDA/QUINTA', 'MAIO', 2025, '(98) 98344-4025'),
('LUEMELLY', 'STARTER', 'QUINTA', 'JUNHO', 2025, '(94) 99231-9837'),
('ADAM', 'LEVEL-2', 'QUINTA', 'MAIO', 2025, '(99) 98546-9533'),
('ARTHUR DA CONCEIÇÃO', 'STARTER', 'SÁBADO', 'JULHO', 2025, '(99) 98249-9141'),
('RAY CHRISTIAN', 'VIP', NULL, 'JULHO', 2025, '1 781 309 0735'),
('DEIRILANE', 'VIP', 'SEGUNDA-FEIRA', 'DEZEMBRO', 2024, '(99) 99118-1378'),
('MATEUS BECKER', 'LEVEL-2', 'QUINTA-FEIRA', 'DEZEMBRO', 2024, '(99) 98150-0474'),
('JOÃO FERREIRA', 'STARTER', 'SABADO', 'DEZEMBRO', 2024, '(99) 98208-7151'),
('HAGNOS PIETRO', 'STARTER', 'SABADO', 'DEZEMBRO', 2024, '(99) 99104-6339'),
('MARCOS VINICIUS', 'STARTER', 'SABADO', 'DEZEMBRO', 2024, '(99) 99226-9898'),
('LUIS OTAVIO VARASQUIM', 'STARTER', 'SABADO', 'DEZEMBRO', 2024, '(99) 99174-7795'),
('RAYRA LUANA', 'STARTER', 'SABADO', 'AGOSTO', 2024, '(63) 99998-0835'),
('LUANA BEATRIZ', 'STARTER', 'SABADO', 'AGOSTO', 2024, '(63) 99998-0835'),
('MARIA LUIZA VALE', 'STARTER', 'SABADO', 'SETEMBRO', 2024, NULL),
('FRANCISCA VALBERLENE', 'STARTER', 'SABADO', 'AGOSTO', 2024, NULL),
('GUSTAVO HENRIQUE', 'VIP', 'SABADO', 'JULHO', 2024, '(98) 98821-9473'),
('HENRIQUE NASCIMENTO', '04 E 05 ANOS', 'SEGUNDA', 'DEZEMBRO', 2024, '(99) 98139-9173'),
('PARIS', 'LEVEL-1', 'SABADO', 'OUTUBRO', 2024, NULL),
('ANA CELESTE MARANHÃO', '06 E 07 ANOS', 'QUINTA', 'DEZEMBRO', 2024, '(99) 99189-0092'),
('HADASSA AMORIM', '06 E 07 ANOS', 'QUINTA', 'DEZEMBRO', 2024, '(99) 98428-9349'),
('ALICE NICOLE', '06 E 07 ANOS', 'QUINTA', 'DEZEMBRO', 2024, '(99) 98428-9349'),
('BENJAMIN QUIROGA', '04 E 05 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 99130-3567'),
('SOPHIA ALBUQUERQUE', '04 E 05 ANOS', 'SABADO', 'SETEMBRO', 2024, '(99) 98513-6714'),
('MARIA CLARA OLIVEIRA', '04 E 05 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 98228-9589'),
('ANA JULIA CRUZ', '04 E 05 ANOS', 'SABADO', 'AGOSTO', 2024, '(99) 99138-3444'),
('PETER MACEDO', '04 E 05 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 98171-4766'),
('ISABELLA ALBUQUERQUE', '04 E 05 ANOS', 'SABADO', 'NOVEMBRO', 2024, '(99) 98107-8332'),
('ABIGAIL', 'VIP', 'SABADO', 'DEZEMBRO', 2024, '(99) 99139-7762'),
('SOPHIA', 'VIP', 'SEGUNDA', 'DEZEMBRO', 2024, '(21) 99673-3878'),
('VALENTINA', 'VIP', 'SEGUNDA', 'DEZEMBRO', 2024, '(21) 99673-3878'),
('LEONIDAS', '08 E 09 ANOS', 'QUINTA', 'DEZEMBRO', 2024, '(99) 99117-0015'),
('JOÃO LUCAS SEGATI', 'LEVEL-1', 'SABADO', 'SETEMBRO', 2024, NULL),
('MATHEUS GABRIEL', 'LEVEL-1', 'SABADO', 'SETEMBRO', 2024, '(99) 99195-6018'),
('STELLA DA CONCEIÇÃO', '08 E 09 ANOS', 'SABADO', 'DEZEMBRO', 2024, NULL),
('PEDRO PAULO', '08 E 09 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 98225-8083'),
('ARTHUR RUFINO', 'LEVEL-2', 'SABADO', 'SETEMBRO', 2024, '(99) 98156-8746'),
('REBECA MARQUES', 'LEVEL-2', 'SABADO', 'SETEMBRO', 2024, '(99) 98192-8000'),
('MARIA LUIZA MACHADO', 'LEVEL-2', 'SABADO', 'OUTUBRO', 2024, '(99) 98549-9781'),
('STEFANIE SORRA', 'LEVEL-2', 'SABADO', 'SETEMBRO', 2024, '(99) 99116-5239'),
('ELOA CARMELITA', 'LEVEL-2', 'SABADO', 'DEZEMBRO', 2024, '(99) 99145-3995'),
('SOFHIA TELES', 'LEVEL-1', 'SABADO', 'DEZEMBRO', 2024, '(99) 99216-4176'),
('REBECA DE SOUSA', 'LEVEL-1', 'SABADO', 'SETEMBRO', 2024, '(99) 99106-4270'),
('RUAN PATROCINIO', 'LEVEL-1', 'SABADO', 'DEZEMBRO', 2024, '(99) 99175-3232'),
('LORENZO MIGUEL', 'LEVEL-1', 'SABADO', 'OUTUBRO', 2024, '(99) 99147-2217'),
('PERPETUO', 'STARTER', 'QUINTA', 'OUTUBRO', 2024, '(99) 98126-9220'),
('VITORIA FERREIRA', 'STARTER', 'QUINTA', 'NOVEMBRO', 2024, '(99) 98167-7772'),
('SAMUEL LACERDA', 'STARTER', 'QUINTA', 'DEZEMBRO', 2024, '(99) 98101-2088'),
('MERCEDES', 'STARTER', 'QUINTA', 'AGOSTO', 2024, NULL),
('BRAYAN LUCCA', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 99183-5650'),
('FABIO FILHO', '06 E 07', 'SABADO', 'OUTUBRO', 2024, NULL),
('ISAAC DOS SANTOS', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 98423-0414'),
('BIANCA SILVA', '06 E 07 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 98234-2212'),
('GABRIELA MARQUES', '06 E 07', 'SABADO', 'JULHO', 2024, '(99) 98192-8000'),
('BENJAMIN FERRAZ', '06 E 07', 'SABADO', 'NOVEMBRO', 2024, '(99) 99149-8111'),
('GABRIEL CARON', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 98278-1965'),
('ERICK NASCIMENTO', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 98110-8650'),
('JOAO PAULO', '08 E 09', 'SABADO', 'AGOSTO', 2024, '(99) 8112-3060'),
('GIOVANA BEATRIZ', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 98514-1671'),
('EMANUEL', '08 E 09', 'SABADO', 'NOVEMBRO', 2024, '(99) 98420-9773'),
('SOPHIA HELLEN', '08 E 09', 'SABADO', 'OUTUBRO', 2024, NULL),
('TULIO MENEZES', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 98275-3322'),
('ANA LIDIA MARANÃO', 'LEVEL-1', 'QUINTA', 'DEZEMBRO', 2024, '(99) 99189-0092'),
('JULIANNE LIMA', 'LEVEL-3', 'SABADO', 'DEZEMBRO', 2024, '(99) 99176-0745'),
('ALDA EMIDIA', 'LEVEL-3', 'SABADO', NULL, 2024, NULL),
('WELKENS', 'LEVEL-3', 'SABADO', NULL, 2024, NULL),
('RENNAN PATROCINIO', 'LEVEL-4', 'SABADO', 'SETEMBRO', 2024, '(99) 99175-3232'),
('CAROLINE DIVINA', 'VIP', 'SEGUNDA', 'DEZEMBRO', 2024, '(99) 98200-0512'),
('CLAUDILANE', 'VIP', 'SEGUNDA/QUARTA', 'DEZEMBRO', 2024, '(83) 98845-3741'),
('MARIANA PEREIRA', 'VIP', 'SABADO', 'DEZEMBRO', 2024, NULL),
('JAMILLY LOPES', 'STARTER', 'SABADO', 'DEZEMBRO', 2024, '(99) 99179-8799'),
('ANA CECILIA', 'LEVEL-3', 'SABADO', 'DEZEMBRO', 2024, NULL),
('ANA CAROLINE', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 99136-7333'),
('MARIA CECILIA', '08 E 09 ANOS', 'SABADO', 'DEZEMBRO', 2024, '(99) 99105-5613'),
('MARIAN QUEIROZ', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 99134-1100'),
('MARIANE FERREIRA', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 99173-5151'),
('CAIO HENRIQUE', 'VIP', 'TERÇA/QUINTA', 'DEZEMBRO', 2024, '(99) 99164-0199'),
('LIVIA MARIA', 'VIP', 'QUARTA', 'DEZEMBRO', 2024, '(99) 99164-0199'),
('LARA MARIA', 'VIP', 'QUARTA', 'DEZEMBRO', 2024, '(99) 99164-0199'),
('RAPHAELA CALINA', 'VIP', 'SEGUNDA/TERÇA', 'DEZEMBRO', 2024, '(99) 99110-8597'),
('THAYLA SOPHIA', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 98224-1345'),
('VICKTOR HUGO', '08 E 09', 'SABADO', 'DEZEMBRO', 2024, '(99) 99117-1565'),
('ESTER MELO', '04 E 05', 'SABADO', 'SETEMBRO', 2024, '(99) 98255-8169'),
('LARA RAFAELLA', '04 E 05', 'SABADO', 'DEZEMBRO', 2024, '(99) 98169-1856'),
('MARIA CECILIA', '04 E 05', 'SABADO', 'DEZEMBRO', 2024, NULL),
('HADASSA TRAJANO', '04 E 05', 'SABADO', 'DEZEMBRO', 2024, NULL),
('MELINA', '04 E 05', 'SABADO', 'DEZEMBRO', 2024, '(99) 99185-2648'),
('FELIPE GABRIEL', '04 E 05', 'SABADO', 'DEZEMBRO', 2024, '(99) 99225-4376'),
('LIVIA MARIA', 'LEVEL-5', 'QUINTA', 'DEZEMBRO', 2024, '(99) 99120-3119'),
('LUISA DE SOUSA', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 99232-1406'),
('MARIA LUIZA CARON', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 98557-1126'),
('MARIA HELOISA PINTO', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 99127-6272'),
('MARIA CLARA GOMES', '06 E 07', 'SABADO', 'SETEMBRO', 2024, NULL),
('HENRY DIEGO', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 99136-5869'),
('ANNA CECILIA', '06 E 07', 'SABADO', 'DEZEMBRO', 2024, '(99) 98542-1954'),
('HAILLA ISABELLY', '04 E 05', 'SABADO', 'SETEMBRO', 2024, NULL),
('CLEISON JOSÉ', 'VIP', 'TERÇA/SEXTA', 'NOVEMBRO', 2024, '353 83 202 2265'),
('ARTHUR RODRIGUES', 'LEVEL-3', 'SABADO', 'NOVEMBRO', 2024, '(99) 99212-6655'),
('ANA KAROLINE CARNEIRO', 'VIP', 'QUARTA/SEXTA', 'OUTUBRO', 2024, '(99) 98173-4757'),
('HEITOR RAFAEL', '06 E 07', 'SABADO', 'OUTUBRO', 2024, '(99) 99147-2217'),
('TANIA MARIA', 'VIP', 'SEGUNDA', NULL, 2024, NULL),
('MAITÊ CARLOS', '04 E 05', 'SABADO', 'SETEMBRO', 2024, '(99) 99153-5032'),
('MARINALVA', 'VIP', 'SEGUNDA', 'SETEMBRO', 2024, '(99) 98142-5348'),
('LORENA VELOSO', '04 E 05 ANOS', 'SABADO', 'SETEMBRO', 2024, '(99) 99183-6998'),
('YTALLA', 'STARTER', 'QUINTA', 'AGOSTO', 2024, '(99) 99147-7420'),
('YASMIN SILVA', 'STARTER', 'QUINTA', 'AGOSTO', 2024, '(99) 99124-1581'),
